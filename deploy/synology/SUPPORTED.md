...
The dsmctl/SPK release version is currently `7.3.2-22`: DSM compatibility train
7.3.2, dsmctl build 22. That managed-NAS compatibility label is separate from
