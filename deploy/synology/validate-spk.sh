...
grep -q -- '--recovery-dir=/data/backups' "$work/package/project/compose.yaml"
...
grep -q 'recovery-retention.*10' "$work/scripts/preupgrade"
grep -q 'dsm-sso.key' "$work/scripts/postupgrade"
grep -q 'recovery-retention.*10' "$work/scripts/postupgrade"
grep -q 'retained.*-gt.*keep' "$work/scripts/recovery-retention"
grep -q 'pre-upgrade-' "$work/scripts/recovery-retention"
grep -q 'pre-restore-' "$work/scripts/recovery-retention"
