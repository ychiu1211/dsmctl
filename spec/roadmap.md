...
| [WI-015](work-items/WI-015-gateway-state-vault-admin.md) | P0 | `in_progress` | F | WI-014 | Add transactional profiles, encrypted vault storage, administration, and runtime invalidation. |
